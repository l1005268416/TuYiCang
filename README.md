...
5. **向量索引层**：Milvus Lite向量库，支持文本语义索引和视觉相似度索引
...
python -m vllm.entrypoints.openai.api_server \
  --model Qwen/Qwen3-VL-Embedding-2B-GPTQ-Int4 \
  --port 8000 \
...
- **模型服务配置**
  ...
  - vllm_api_url：vLLM API地址（默认 http://localhost:8000）
