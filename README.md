...
sudo docker compose up -d
 ...
 ```
开启用户验证参照：https://www.ai-community.tech/docs/adminGuide/authenticate.md
...
- **文搜图响应时间**：< 0.2秒
- **图搜图响应时间**：< 0.2秒
- **入库速度**：约 100-300 张/分钟（取决于硬件配置）
- **显存占用**：约 6-12GB
- **速率**：V100显卡下，VLM速度约0.55s/次，文本嵌入约0.26s/次，视觉嵌入约0.20s/次,支持并发处理
``` plain
